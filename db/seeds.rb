...
equip4 = EquipmentItem.new(category: cat2, title: "Man's snowboard",
                           ...
                           description: "Loved doing tricks on this board, broke my leg can't use at the moment")
...
Booking.create!(user_id: user1.id, equipment_item_id: equip6.id, booking_date: Date.today)

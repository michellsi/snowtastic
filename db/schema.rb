...
ActiveRecord::Schema.define(version: 2022_02_24_102726) do
  ...
  create_table "equipment_items", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_equipment_items_on_user_id"
  end
  ...
  add_foreign_key "equipment_items", "categories"
